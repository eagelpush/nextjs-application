...
export function QuickActions() {
  const actions = [
    ...
    },
    {
      ...
      icon: IconChartBar,
      color:
        "bg-amber-50 hover:bg-amber-100 dark:bg-amber-950/50 dark:hover:bg-amber-950/70",
    ...
    },
    {
      ...
      icon: IconSettings,
      color:
        "bg-gray-50 hover:bg-gray-100 dark:bg-gray-950/50 dark:hover:bg-gray-950/70",
